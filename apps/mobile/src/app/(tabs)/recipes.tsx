    ...
    <View style={styles.container}>
      ...
      <View style={styles.recipesContainer}>
        <View style={styles.recipeCard}>
          <Image style={styles.recipeImage} source={{uri: 'https://static.food-swipe.app/9b9b6ccc-ac28-45af-a245-1d0dd9d00547.jpeg'}}/>
      ...
      />
            <View style={styles.recipeCardOverlayContent}>
              <AppText style={styles.recipeCardText}>Recipe Name</AppText>
              <View style={styles.recipeCardDetailsContainer}>
                <AppText style={styles.recipeCardDetailText}>1 cal</AppText>
                <View style={{display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4}}>
