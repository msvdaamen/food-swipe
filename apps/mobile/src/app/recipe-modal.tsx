  ...
  const downAnimation = (values: ExitAnimationsValues): LayoutAnimation => {
    'worklet'
     const animations: StyleProps = {
       transform: [
         {
           translateY: withTiming(direction.value === 1 ? '100%' : '-100%', {duration: 100})
         },
         {
           rotateX: withTiming( direction.value === 1 ? '90deg' : '-90deg', {duration: 100})
         }
       ],
     };
     const initialValues: StyleProps = {
    ...
    <View style={styles.ingredientsContainer}>
      ...
      <View style={styles.amountContainer}>
        ...
        >
          ...
          {range.map((value) => (
            value === amount ?
              <AnimatedFText style={styles.ingredientAmountText} key={value} entering={upAnimation} exiting={downAnimation}>
                {value}
              </AnimatedFText>
              : null
          ))}
