...
<template>
  <div class="sidebar h-dvh flex-col gap-1">
    ...
    <div class="overflow-hidden border-t-2 border-gray-300">
      <div class="flex max-w-max items-center gap-2 overflow-hidden text-ellipsis p-4 text-sm">
        <div
          class="flex aspect-square w-8 items-center justify-center rounded-full border border-gray-200 bg-white text-xs"
        >
          M
        </div>
