/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c0c225aa16c72be5fe8a44c942c849a)
// Runtime types generated with workerd@1.20260616.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	FOOD_SWIPE_CACHE: KVNamespace;
	R2_PUBLIC: R2Bucket;
	R2_PRIVATE: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	API_URL: "https://api.food-swipe.app" | "http://localhost:8787";
	WEB_URL: "https://admin.food-swipe.app" | "http://localhost:5173";
	ENVIRONMENT: "production" | "development";
	STORAGE_PUBLIC_URL: "https://static.food-swipe.app" | "https://static-dev.food-swipe.app";
	DATABASE_URL: string;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		R2_PRIVATE: R2Bucket;
		HYPERDRIVE: Hyperdrive;
		API_URL: "https://api.food-swipe.app";
		WEB_URL: "https://admin.food-swipe.app";
		ENVIRONMENT: "production";
		STORAGE_PUBLIC_URL: "https://static.food-swipe.app";
		DATABASE_URL: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "WEB_URL" | "ENVIRONMENT" | "STORAGE_PUBLIC_URL" | "DATABASE_URL">> {}
}
