...
import { useDeleteIngredient } from "@/features/ingredient/api/delete-ingredient";
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button
                          variant="outline"
                          size="icon"
                          onClick={() => openUpdateIngredientDialog(ingredient.id, ingredient.name)}
                        >
                        ...
                        <Button
                          variant="destructive"
                          size="icon"
                          onClick={() => deleteIngredient.mutate({ ingredientId: ingredient.id })}
                        >
